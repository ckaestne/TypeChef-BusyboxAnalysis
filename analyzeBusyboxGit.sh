...
srcPath="gitbusybox"
export partialPreprocFlags="-x CONFIG_ --include gitbusybox/header.h --include mheader.h -I $srcPath/include --featureModelFExpr gitbusybox/featureModel --debugInterface --writePI --recordTiming --parserstatistics"
## Reset output
